...
mod tests {
    ...
    async fn test_search_instances_returns_required_multiframe_metadata_fields() {
        ...
        assert_eq!(json[0]["00200032"]["Value"], json!(["0", "0", "0"]));
        assert_eq!(
            json[0]["00200037"]["Value"],
            json!(["1", "0", "0", "0", "1", "0"])
        );
        assert_eq!(json[0]["00200052"]["Value"][0], json!("9.8.7.6.5"));
        assert_eq!(json[0]["00280030"]["Value"], json!(["0.5", "0.5"]));
        assert_eq!(json[0]["00180050"]["Value"][0], json!("1.0"));
        assert_eq!(json[0]["00180088"]["Value"][0], json!("1.0"));
    }
}
